...
const ai = new GoogleGenAI({ apiKey: 'AIzaSyCqfrI45eILHz8Z1FYD7MnjPM0F79cnW5s' });
...
function App() {
  ...
  async function main() {
    const response = await ai.models.generateContent({
      ...
      prompt: `Ты — генератор «Передбачення на день» в стиле забавных чековых предсказаний.
        Главное правило:
