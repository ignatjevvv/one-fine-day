          ...
          parts: [
            {
              ...
              - Тон: Побутовий абсурд, легка іронія, "життєзавтра".

              ІНСТРУКЦІЯ З УНІКАЛЬНОСТІ:
              Замість стандартних прогнозів, описуй дивні побутові мікро-події. Використовуй різноманітні конструкції: "Схоже, що...", "Будь готовий до...", "Є підозра, що...", "Твій план на сьогодні — ...", або просто констатацію факту.
